...
<div class="container">
	<div class="user-data m-t-40">
		<div class="col-md-12">
			<div id="cuerpo">
				<h2>Modificar Imagen de Fondo de video</h2>
				<p>Aquí Usted podrá actualizar la imagen que está de fondo del video</p>
				<br>
