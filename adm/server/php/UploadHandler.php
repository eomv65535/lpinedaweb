...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null,$otro) {
		$this->otro_nombre=$otro;
        $this->response = array();
        $this->options = array(
