<?php session_start();
  ...
  if((isset($_SESSION["usuario_lp"]) && !empty($_SESSION["usuario_lp"])) )
   {    
	...
	$menr="Seguro de eliminar el Proyecto: '".$nombre."'?";

	$eliminalo="proyectos_eliminar2.php?id=".$_GET["id"];
	...
	echo '<div align="center"><a class="btn btn-primary" style="text-decoration:none" href="'.$eliminalo.'">Eliminar</a>
      					<a href="proyectos.php" class="btn btn-danger" style="text-decoration:none">Cancelar</a>
