			...
			<div id="cuerpo">
				<div class="card-body">
					<div class="card-title">
						<h3 class="text-center title-2">Modificar Quotes</h3>
					</div>
					<hr>
					<div id="bloquelogin">
						<form action="quotes_modificar2.php" name="form1" method="post">
							
							<input id="id" type="hidden" name="id" value="<?php echo $elpk;?>">
							<div class="form-group">
								<label for="nombre" class="control-label mb-1">Autor (Esp)</label>
								<input class="form-control" name="titu_esp" id="titu_esp" type="text" value="<?php echo $titu_esp;?>">
							</div>
							<div class="form-group">
								<label for="nombre" class="control-label mb-1">Autor (Eng)</label>
								<input class="form-control" name="titu_eng" id="titu_eng" type="text" value="<?php echo $titu_eng;?>">
							</div>
							<div class="form-group">
								<label for="nombre" class="control-label mb-1">Texto (Esp)</label>
								<input class="form-control" name="des_esp" id="des_esp" type="text" value="<?php echo $des_esp;?>">
							</div>
							<div class="form-group">
								<label for="nombre" class="control-label mb-1">Texto (Eng)</label>
								<input class="form-control" name="des_eng" id="des_eng" type="text" value="<?php echo $des_eng;?>">
							</div>
